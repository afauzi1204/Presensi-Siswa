<meta http-equiv="refresh" content="100" href="tarik_presensi_masuk.php">
...
<div class="card mb-3">
  ...
  <div class="card-body">
    <div class="table-responsive">
      <a href="tarik_presensi_masuk.php" class="btn btn-info" style="float: right;"><i class="fa fa-download"></i> Tarik Data</a><br><br>
